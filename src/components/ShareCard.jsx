...
// decision, edge, stake, the agent's own reasoning, and which pipeline
// produced it.
  ...
  return (
    <div className="share-card" ref={ref}>
      ...
      <div className="sc-stats">
        <div className="sc-stat"><div className="v decision-value">{decisionLabel(bet)}</div><div className="l">Decision</div></div>
